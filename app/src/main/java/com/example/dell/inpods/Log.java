...
//        setSupportActionBar(toolbar);
        ...
        btnReset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Log.this, ResetPaswordActivity.class));
            }
        });
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    if (password.length() < 6) {
                                        ...
                                        Toast.makeText(Log.this, getString(R.string.auth_failed), Toast.LENGTH_LONG).show();
                                    }
                                } else {
                                    Intent intent = new Intent(Log.this, QuizActivity.class);
